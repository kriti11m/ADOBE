                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className={`w-full p-3 rounded-xl focus:outline-none transition-all duration-300 ${
                        isDarkMode 
                          ? 'bg-white/10 border border-white/20 text-white placeholder:text-white/50 focus:border-blue-500' 
                  ...
                  <div className="flex gap-3 pt-4">
                    <button
                      ...
                      className="flex-1 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-3 rounded-xl font-medium transition-all duration-300 hover:scale-105 shadow-lg"
                    >
              ...
              <div className="space-y-4">
                ...
                {!loading && profiles.length === 0 && (
                  <div className="text-center py-12">
                    ...
                    <button
                      onClick={() => setShowCreateForm(true)}
                      className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-6 py-3 rounded-xl font-medium transition-all duration-300 hover:scale-105 shadow-lg"
                    >
                      Create Profile
                    </button>
                  </div>
                      ...
                      >
                        <div className="p-4">
                          <div className="flex items-center justify-between mb-3">
                            ...
                            {isSelected && (
                              <div className="bg-gradient-to-r from-blue-500 to-purple-500 text-white border-0 px-3 py-1 rounded-full text-sm font-medium">
                                Selected
                              </div>
                            )}
                          </div>
